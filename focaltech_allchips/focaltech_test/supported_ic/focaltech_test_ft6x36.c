...
bool start_test_ft6x36(void)
{
    ...
    for (iItemCount = 0; iItemCount < test_data.test_num; iItemCount++) {
        ...
        #if FACTORY_COMPATIBLE_BY_DAICHENG
        if (vendor_id_template == FTS_VENDOR_ID){
            FTS_DEBUG("vendor_id_template = %d,enter DELTA_CB_TEST case",vendor_id_template);
            ///////////////////////////////////////////////////////Code_FT6X36_DELTA_CB_TEST
            ...
            FTS_DEBUG("vendor_id_template = %d,not need enter DELTA_CB_TEST case",vendor_id_template);
        }
        #else
        if (Code_FT6X36_DELTA_CB_TEST == test_data.test_item[iItemCount].itemcode
           ) {
