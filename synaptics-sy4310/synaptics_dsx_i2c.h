...
#define F12_2D_CTRL23_OFFSET 0X08
...
#define GPIO146_LCM_RESET 	(GPIO146 | 0x80000000)
#define TD_TPD_CANCEL_TK_SLIP_UP 0
#define	GN_BSP_TP_MATCH_MODE	0
...
struct synaptics_rmi4_data {
	...
	bool staying_awake;
	bool ext_afe_button;
	bool stay_update_awake;
    bool stay_selftest_awake;
