...
//#define FW_IMAGE_NAME "synaptics/PR2648779-td4310-i2c-tianma_Gionee_17G13_17130007.img"
#define FW_IMAGE_NAME "synaptics/td4310/startup_fw_update.img"
...
//extern int synaptics_update_fw;
...
// Gionee <GN_BSP_CTP> <linzhanchi> <20170829>	modify for ID186117 begin
	if (image_fw_id != device_fw_id) {
		dev_info(&fwu->rmi4_data->i2c_client->dev,
				"%s: Image firmware ID is not the same as device firmware ID\n",
				__func__);
		flash_area = UI_FIRMWARE;
		goto exit;
	}
// Gionee <GN_BSP_CTP> <linzhanchi> <20170829>	modify for ID186117 end
...
// Gionee <GN_BSP_CTP> <linzhanchi> <20170818>  modify for ID186117 begin
	//synaptics_update_fw = 1;
	retval = fwu_start_reflash();
	//synaptics_update_fw = 0;
	fw_is_upgrad = 1;
