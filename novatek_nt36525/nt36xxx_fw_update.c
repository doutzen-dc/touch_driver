...
//Chenyee <CY_BSP_CTP> <xuel> <2017-06-27> Modify For 65840 Begin
extern int nvt_register_hardware_info(void);
//Chenyee <CY_BSP_CTP> <xuel> <2017-06-27> Modify For 65840 End

//Chenyee <CY_BSP_CTP> <xuel> <2018-01-29> Modify For #CSW1705A-1389 Begin
#ifdef CONFIG_CY_BSP_CTP_NV36525B_HALL_SUPPORT
extern int hall_gpio_eint;
extern int cy_hall_get_gpio_state(int gpio_num);
extern void nv_holster_setting(int enable);
#endif
//Chenyee <CY_BSP_CTP> <xuel> <2018-01-29> Modify For #CSW1705A-1389 End
...
//Chenyee <CY_BSP_CTP> <xuel> <2017-06-27> Modify For 65840 Begin
	...
	if (buf[1] > fw_entry->data[FW_BIN_VER_OFFSET])
		...
		return 0;
#else
	if (buf[1] != fw_entry->data[FW_BIN_VER_OFFSET])	//ic_fw != bin_fw
		return 0;
	else
		return 1;
#endif
...
//Chenyee <CY_BSP_CTP> <xuel> <2018-01-29> Modify For #CSW1705A-1389 Begin
#ifdef CONFIG_CY_BSP_CTP_NV36525B_HALL_SUPPORT
	if(cy_hall_get_gpio_state(hall_gpio_eint) == 0) {
